...
import {removeSyriacScriptDiacritics} from './aii/assyrian-neo-aramaic-text-preprocessors';
import {
    addHamzaBottom,
    addHamzaTop,
...
import {arabicTransforms} from './ar/arabic-transforms';
import {normalizeRadicalCharacters} from './CJK-util';
import {eszettPreprocessor} from './de/german-text-preprocessors';
import {germanTransforms} from './de/german-transforms';
import {englishTransforms} from './en/english-transforms';
import {esperantoTransforms} from './eo/esperanto-transforms';
import {spanishTransforms} from './es/spanish-transforms';
import {apostropheVariants} from './fr/french-text-preprocessors';
import {frenchTransforms} from './fr/french-transforms';
import {irishTransforms} from './ga/irish-transforms';
import {convertLatinToGreek} from './grc/ancient-greek-processors';
import {ancientGreekTransforms} from './grc/ancient-greek-transforms';
import {
...
import {georgianTransforms} from './ka/georgian-transforms';
import {disassembleHangul, reassembleHangul} from './ko/korean-text-processors';
import {koreanTransforms} from './ko/korean-transforms';
import {processDiphtongs} from './la/latin-text-preprocessors';
import {latinTransforms} from './la/latin-transforms';
import {removeRussianDiacritics, yoToE} from './ru/russian-text-preprocessors';
import {oldIrishTransforms} from './sga/old-irish-transforms';
import {removeSerboCroatianAccentMarks} from './sh/serbo-croatian-text-preprocessors';
import {albanianTransforms} from './sq/albanian-transforms';
import {capitalizeFirstLetter, decapitalize, removeAlphabeticDiacritics} from './text-processors';
import {tagalogTransforms} from './tl/tagalog-transforms';
import {normalizeDiacritics} from './vi/viet-text-preprocessors';
import {convertFinalLetters, convertYiddishLigatures} from './yi/yiddish-text-postprocessors';
import {combineYiddishLigatures, removeYiddishDiacritics} from './yi/yiddish-text-preprocessors';
import {yiddishTransforms} from './yi/yiddish-transforms';
import {isStringPartiallyChinese, normalizePinyin} from './zh/chinese';
