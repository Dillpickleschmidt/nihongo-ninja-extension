...
import {getDisambiguations, getGroupedPronunciations, getTermFrequency, groupKanjiFrequencies, groupTermFrequencies, groupTermTags, isNonNounVerbOrAdjective} from '../dictionary/dictionary-data-util';
import {HtmlTemplateCollection} from '../dom/html-template-collection';
import {distributeFurigana, getKanaMorae, getPitchCategory, isCodePointKanji} from '../language/ja/japanese';
import {getLanguageFromText} from '../language/text-utilities';
import {PronunciationGenerator} from './pronunciation-generator';
...
export class DisplayGenerator {
    ...
    /** */
    async prepare() {
        await this._templates.loadFromFiles(['/yomitan/templates/templates-display.html']);
        this.updateHotkeys();
    }
