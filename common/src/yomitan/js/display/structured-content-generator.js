...
import {DisplayContentManager} from '../display/display-content-manager';
...
export class StructuredContentGenerator {
    ...
    createDefinitionImage(data, dictionary) {
        ...
        if (this._contentManager !== null) {
            const image = /** @type {HTMLCanvasElement} */ (this._createElement('canvas', 'gloss-image'));
            ...
            this._contentManager.loadMedia(
                path,
                dictionary,
                image.transferControlToOffscreen(),
            );
        }
